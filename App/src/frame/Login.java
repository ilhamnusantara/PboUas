...
public class Login extends javax.swing.JFrame {
    ...
    static  ControllerLogin controller= new ControllerLogin();
    ...
    public Login() {
        initComponents();
//        ControllerLogin.login(username1, password);
    }
    ...
    private void initComponents() {
        ...
        judul.setText("VAPOR ITATS TERCINTA");
...
//        Controller.Controller.insert(userName, passWord, nama, status, nilaiIpa, nilaiIps, nilaiIndo);
        ControllerLogin.login(username1.getText(), password1.getText());
//          if(controller.login(username1.getText(),password1.getText()).equals("admin"))
//                {
//                   Home d =new Home();
//                   d.setVisible(true);
//                   setVisible(false);
